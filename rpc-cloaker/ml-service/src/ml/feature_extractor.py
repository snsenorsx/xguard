...
class FeatureExtractor:
    ...
    def extract_features(self, visitor_data: Dict[str, Any]) -> np.ndarray:
        ...
        features.extend(self._extract_geo_features(visitor_data))
        features.extend(self._extract_device_features(visitor_data))
    ...
    def _extract_geo_features(self, data: Dict) -> List[float]:
        ...
        features = [
            ...
            self._get_country_risk_score(geo.get('country')),  # Country risk score
    ...
    def _extract_device_features(self, data: Dict) -> List[float]:
        ...
        features = [
            ...
            float(self._check_device_browser_mismatch(device, browser, os))
        ]
    ...
    def _get_country_risk_score(self, country: Optional[str]) -> float:
        ...
        # High-risk countries for bot traffic
