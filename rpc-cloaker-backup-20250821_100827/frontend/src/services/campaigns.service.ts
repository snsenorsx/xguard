...
export interface Campaign {
  ...
  moneyPageUrl: string
  safePageUrl: string
  redirectType: '301' | '302' | 'js' | 'meta' | 'direct'  // legacy field
  moneyPageRedirectType: '301' | '302' | 'js' | 'meta' | 'direct' | 'no_action'
  safePageRedirectType: '301' | '302' | 'js' | 'meta' | 'direct' | 'no_action'
  notes?: string
  createdAt: string
  updatedAt: string
  stats?: {
...
export interface CreateCampaignDto {
  ...
  moneyPageUrl: string
  safePageUrl: string
  redirectType?: '301' | '302' | 'js' | 'meta' | 'direct'  // legacy field, optional
  moneyPageRedirectType: '301' | '302' | 'js' | 'meta' | 'direct' | 'no_action'
  safePageRedirectType: '301' | '302' | 'js' | 'meta' | 'direct' | 'no_action'
  notes?: string
}
